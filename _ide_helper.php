...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Helper\MM\UrlGenerator $instance */
         ...
         *
         * @param \Closure $callback
         * @return \App\Helper\MM\UrlGenerator 
         * @static 
         */ 
        ...
        public static function macro($name, $macro)
        {            //Method inherited from \Illuminate\Routing\UrlGenerator         
                        \App\Helper\MM\UrlGenerator::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Illuminate\Routing\UrlGenerator         
                        \App\Helper\MM\UrlGenerator::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {            //Method inherited from \Illuminate\Routing\UrlGenerator         
                        return \App\Helper\MM\UrlGenerator::hasMacro($name);
        }
     ...
     */ 
        ...
        {
                        return \Illuminate\Support\Arr::accessible($value);
        }
                    /**
         ...
         *
         * @param \Illuminate\Support\iterable $array
         * @return array 
         * @static 
         */ 
         ...
         *
         * @param \Illuminate\Support\iterable $arrays
         * @return array 
         * @static 
         */ 
        public static function crossJoin(...$arrays)
        {
                        return \Illuminate\Support\Arr::crossJoin(...$arrays);
        }
                    /**
        ...
        {
                        return \Illuminate\Support\Arr::exists($array, $key);
        }
                    /**
        ...
        {
                        return \Illuminate\Support\Arr::hasAny($array, $keys);
        }
                    /**
        ...
        {
                        return \Illuminate\Support\Arr::random($array, $number);
        }
                    /**
        ...
        {
                        return \Illuminate\Support\Arr::shuffle($array, $seed);
        }
                    /**
        ...
        {
                        return \Illuminate\Support\Arr::query($array);
        }
                    /**
        ...
        public static function macro($name, $macro)
        {
                        \Illuminate\Support\Arr::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Illuminate\Support\Arr::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \Illuminate\Support\Arr::hasMacro($name);
        }
     ...
     */ 
        ...
        {
                        return \Illuminate\Support\Str::afterLast($subject, $search);
        }
                    /**
        ...
        {
                        return \Illuminate\Support\Str::ascii($value, $language);
        }
                    /**
        ...
        {
                        return \Illuminate\Support\Str::before($subject, $search);
        }
                    /**
        ...
        {
                        return \Illuminate\Support\Str::beforeLast($subject, $search);
        }
                    /**
        ...
        {
                        return \Illuminate\Support\Str::containsAll($haystack, $needles);
        }
                    /**
        ...
        {
                        return \Illuminate\Support\Str::length($value, $encoding);
        }
                    /**
         ...
         * @param string $callback
         * @param string|null $default
         * @return \Illuminate\Support\array<int, string|null>
         * @static 
         */ 
        public static function parseCallback($callback, $default = null)
        {
                        return \Illuminate\Support\Str::parseCallback($callback, $default);
        }
                    /**
        ...
        {
                        return \Illuminate\Support\Str::pluralStudly($value, $count);
        }
                    /**
         ...
         *
         * @param string $search
         * @param \Illuminate\Support\array<int|\Illuminate\Support\string,  string>  $replace
         * @param string $subject
         * @return string 
         * @static 
         */ 
        ...
        {
                        return \Illuminate\Support\Str::start($value, $prefix);
        }
                    /**
        ...
        {
                        return \Illuminate\Support\Str::substr($string, $start, $length);
        }
                    /**
         ...
         * @static 
         */ 
        public static function createUuidsUsing($factory = null)
        {
                        \Illuminate\Support\Str::createUuidsUsing($factory);
        }
                    /**
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Illuminate\Support\Str::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \Illuminate\Support\Str::hasMacro($name);
        }
...
namespace  { 
            ...
            class Arr extends \Facades\Illuminate\Support\Arr {}
            ...
            class Str extends \Facades\Illuminate\Support\Str {}
